...
namespace AppointmentApp.Api.Controllers
{
    ...
    public class AccountController : AbpApiController
    {
        ...
        public AccountController(LogInManager logInManager, TenantManager tenantManager, UserManager userManager, RoleManager roleManager, IUnitOfWorkManager unitOfWorkManager)
        {
