...
export class ChannelService {
    ...
    slotChanged: Subject<Slot> = new Subject<Slot>();
    ...
    constructor(
        ...
        this.hubProxy.on("appMessage", (messageData) => {
            console.log(messageData);
            let toast = this.toastCtrl.create({
                message: "New Message! " + messageData.senderName + ": " + messageData.shortMessage,
                duration: 2000,
                position: 'top'
            });
            toast.present();
        ...
        this.hubProxy.on("slotChanged", (slotData: Slot) => {
            console.log(slotData);
            this.slotChanged.next(slotData);
        });
    }
    ...
    start(): void {
        ...
        let access_token = this.userService.access_token;

        this.hubConnection.qs = { 'access_token': access_token };
